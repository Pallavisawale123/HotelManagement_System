	...
	public SearchRoom() throws SQLException {
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String SQL = "select * from room where room_type = '"+c1.getSelectedItem()+"'";
				String SQL2 = "select * from room where room_availability = 'Available' AND room_type = '"+c1.getSelectedItem()+"'";
			try{			
                                conn c = new conn();
